...
print("📥 Cargando datos de entrenamiento IRPF...")
...
print(f"✅ Datos cargados: {len(train_data)} muestras para entrenar la entidad IRPF.")
...
print("\n✅ Modelo IRPF guardado en:", MODEL_PATH)
