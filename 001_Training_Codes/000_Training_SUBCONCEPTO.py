# -*- coding: utf-8 -*-
"""
Created on Tue Jul 15 21:03:10 2025
...
archivo_entrenamiento = os.path.join(DATA_PATH, 'TrainingSet_SUBCONCEPTO.xlsx')
...
for _, row in df.iterrows():
    ...
    entidad = row.get('entidad', 'SUBCONCEPTO')  # Cambiado
    train_data.append((texto, {'entities': [(start, end, entidad)]}))

print(f"✅ Datos cargados: {len(train_data)} muestras para entrenar la entidad SUBCONCEPTO.")
...
print("\n✅ Modelo SUBCONCEPTO guardado en:", MODEL_PATH)
