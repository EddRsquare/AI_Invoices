# -*- coding: utf-8 -*-
"""
Created on Mon Jul 14 11:08:43 2025
...
archivo_entrenamiento = os.path.join(DATA_PATH, 'TrainingSet_NUM_FACTURA.xlsx')

# True = desde cero, False = continuar entrenamiento
...
print(f"✅ Datos cargados: {len(train_data)} muestras para entrenar la entidad NUM_FACTURA.")
...
print("\n✅ Modelo NUM_FACTURA guardado en:", MODEL_PATH)
