# -*- coding: utf-8 -*-
"""
Created on Tue Jul 15 23:45:48 2025
...
archivo_entrenamiento = os.path.join(DATA_PATH, 'TrainingSet_TOTALDERECHOS.xlsx')
...
for _, row in df.iterrows():
    ...
    entidad = row.get('entidad', 'TOTALDERECHOS')
    train_data.append((texto, {'entities': [(start, end, entidad)]}))

print(f"✅ Datos cargados: {len(train_data)} muestras para entrenar la entidad TOTALDERECHOS.")
...
print("\n✅ Modelo TOTALDERECHOS guardado en:", MODEL_PATH)
