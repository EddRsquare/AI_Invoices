# -*- coding: utf-8 -*-
"""
Created on Wed Jul 16 00:40:24 2025
...
archivo_entrenamiento = os.path.join(DATA_PATH, 'TrainingSet_SUPLIDOS.xlsx')
...
for _, row in df.iterrows():
    ...
    entidad = row.get('entidad', 'SUPLIDOS')  # Aseguramos etiqueta
    train_data.append((texto, {'entities': [(start, end, entidad)]}))

print(f"✅ Datos cargados: {len(train_data)} muestras para entrenar la entidad SUPLIDOS.")
...
print("\n✅ Modelo SUPLIDOS guardado en:", MODEL_PATH)
