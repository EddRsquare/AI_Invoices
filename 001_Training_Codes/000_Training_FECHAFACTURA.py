# -*- coding: utf-8 -*-
"""
Created on Mon Jul 21 11:32:49 2025
...
MODEL_PATH = os.path.join(BASE_PATH, 'model', 'FechaFactura')  # <-- Ruta modelo FechaFactura
archivo_entrenamiento = os.path.join(DATA_PATH, 'TrainingSet_FechaFactura.xlsx')

entrenar_desde_cero = True  # True = nuevo modelo desde cero

# -------------------- CARGA DATOS ENTRENAMIENTO --------------------
print("📥 Cargando datos de entrenamiento para FechaFactura...")
...
for _, row in df.iterrows():
    ...
    entidad = row.get('entidad', 'FechaFactura')
    train_data.append((texto, {'entities': [(start, end, entidad)]}))

print(f"✅ Datos cargados: {len(train_data)} muestras para entrenar la entidad FechaFactura.")
...
print("\n✅ Modelo FechaFactura guardado en:", MODEL_PATH)
