# -*- coding: utf-8 -*-
"""
Created on Fri Jul 11 12:42:33 2025

@author: r_rsq
"""

# 000_Training_TOTAL_FACTURA.py
...
archivo_entrenamiento = os.path.join(DATA_PATH, 'TrainingSet_TOTAL_FACTURA.xlsx')
...
for _, row in df.iterrows():
    ...
    entidad = row.get('entidad', 'TOTAL_FACTURA')  # Por defecto
    train_data.append((texto, {'entities': [(start, end, entidad)]}))

print(f"✅ Datos cargados: {len(train_data)} muestras para entrenar la entidad TOTAL_FACTURA.")
...
print("\n✅ Modelo TOTAL_FACTURA guardado en:", MODEL_PATH)
